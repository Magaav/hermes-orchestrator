...
echo "  horc restart               Restart all nodes"
echo "  horc restart [name]        Restart one node (e.g. orchestrator)"
...
echo "  horc update help           Show simplified update help"
echo "  horc update all [--force]  Refresh /local/hermes-agent and reseed every node"
echo "  horc update node [name] [--force] Refresh /local/hermes-agent and reseed one node"
...
echo "  horc restart"
echo "  horc restart orchestrator"
echo "  horc update help"
echo "  horc update all"
echo "  horc update node node1 --force"
echo ""
