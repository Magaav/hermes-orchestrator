...
Canonical shared host root: `/local/agents/public/scripts` (with `/local/scripts` kept as a compatibility entrypoint).
...
- private canonical backup scripts: `/local/agents/private/scripts/backup/*.sh`.
