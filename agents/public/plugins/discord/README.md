...
- Node cron launchers -> `/local/agents/private/crons/<node>/`

`/local/agents/public/plugins/discord/*` is the canonical host source of truth.
`/local/plugins/discord/*` remains a compatibility alias.
