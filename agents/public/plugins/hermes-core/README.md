...
- Shared wiki engine:
  ...
  - shared root: `/local/agents/private/shared/wiki`
...
- Prestart reapply pipeline (canonical):
  - `bash /local/agents/public/plugins/hermes-core/scripts/prestart_reapply.sh [--strict]`
- Wiki engine CLI:
  - `python3 /local/agents/public/plugins/hermes-core/scripts/wiki_engine.py --help`
- Reapply patch:
  - `python3 /local/agents/public/plugins/hermes-core/scripts/reapply_node_agent_followup_footer.py`
- Verify markers:
  - `python3 /local/agents/public/plugins/hermes-core/scripts/verify_node_agent_followup_footer.py`

## Wiki Engine Notes

- The live wiki content under `/local/agents/private/shared/wiki` is deployment-local and ignored by git.
