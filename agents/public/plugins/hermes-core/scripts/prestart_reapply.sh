...
DISCORD_PLUGIN_ROOT="${HERMES_DISCORD_PLUGIN_DIR:-/local/agents/public/plugins/discord}"
if [[ ! -d "$DISCORD_PLUGIN_ROOT" && -d "/local/plugins/discord" ]]; then
  DISCORD_PLUGIN_ROOT="/local/plugins/discord"
fi
...
HERMES_CORE_PLUGIN_ROOT="${HERMES_CORE_PLUGIN_DIR:-/local/agents/public/plugins/hermes-core}"
if [[ ! -d "$HERMES_CORE_PLUGIN_ROOT" && -d "/local/plugins/hermes-core" ]]; then
  HERMES_CORE_PLUGIN_ROOT="/local/plugins/hermes-core"
fi
