...
if (normalizedTextSha256(preloadJsPath) !== normalizedTextSha256(sourcePreloadJsPath)) fail("Extracted installer preload does not match the release input");
...
if (normalizedTextSha256(dispatcherHealthPath) !== normalizedTextSha256(sourceDispatcherHealthPath)) fail("Extracted dispatcher recovery lease module does not match the release input");
...
if (normalizedTextSha256(packageIntegrityPath) !== normalizedTextSha256(sourcePackageIntegrityPath) || normalizedTextSha256(nativeSessionProofPath) !== normalizedTextSha256(sourceNativeSessionProofPath)) {
  fail("Extracted app.asar installed-proof modules do not match the release inputs");
}
if (
  !fs.existsSync(fullPowerExecutorPath)
  || normalizedTextSha256(fullPowerExecutorPath) !== normalizedTextSha256(sourceFullPowerExecutorPath)
...
if (
  ...
  || normalizedTextSha256(companionOverlayPath) !== normalizedTextSha256(sourceCompanionOverlayPath)
  || normalizedTextSha256(companionStartupPath) !== normalizedTextSha256(sourceCompanionStartupPath)
  || normalizedTextSha256(windowsNativeCommandsPath) !== normalizedTextSha256(sourceWindowsNativeCommandsPath)
  || normalizedTextSha256(windowsDesktopControlPath) !== normalizedTextSha256(sourceWindowsDesktopControlPath)
  || normalizedTextSha256(windowsDesktopUiaPath) !== normalizedTextSha256(sourceWindowsDesktopUiaPath)
  || normalizedTextSha256(nativeCapabilitiesPath) !== normalizedTextSha256(sourceNativeCapabilitiesPath)
