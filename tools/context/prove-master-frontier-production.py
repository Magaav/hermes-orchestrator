...
COMMANDS: tuple[tuple[str, list[str], str], ...] = (
    ...
    ("browser-actions", ["python3", "plugins/wasm-agent/tests/master_frontier_browser_actions.test.py"], "behavioral"),
    ...
    ("frontier-capability-foundry", ["python3", "plugins/wasm-agent/tests/master_frontier_capability_foundry.test.py"], "behavioral"),
    ("frontier-cloud-canary-contract", ["python3", "plugins/wasm-agent/tests/master_frontier_cloud_canary.test.py"], "behavioral"),
    ("frontier-event-anchor-adapter", ["python3", "plugins/wasm-agent/tests/master_frontier_event_anchor_adapter.test.py"], "behavioral"),
    ("frontier-event-anchor-store", ["python3", "plugins/wasm-agent/tests/master_frontier_event_anchor_store.test.py"], "behavioral"),
    ("frontier-event-anchor-wiring", ["python3", "plugins/wasm-agent/tests/master_frontier_event_anchor_wiring.test.py"], "behavioral"),
    ("frontier-event-integrity", ["python3", "plugins/wasm-agent/tests/master_frontier_event_integrity.test.py"], "behavioral"),
    ("frontier-visual-teacher-store", ["python3", "plugins/wasm-agent/tests/master_frontier_visual_teacher_store.test.py"], "behavioral"),
    ...
    ("frontier-v5-verification-answer", ["python3", "plugins/wasm-agent/tests/master_frontier_v5_verification_answer.test.py"], "behavioral"),
    ...
    ("session-memory", ["python3", "plugins/wasm-agent/tests/master_frontier_session_memory.test.py"], "behavioral"),
    ("continuation", ["node", "plugins/wasm-agent/tests/master_frontier_continuation.test.js"], "behavioral"),
    ("change-evidence", ["node", "plugins/wasm-agent/tests/master_frontier_change_evidence.test.js"], "behavioral"),
    ("live-commentary", ["node", "plugins/wasm-agent/tests/master_frontier_live_commentary.test.js"], "behavioral"),
    ...
    ("active-space-context", ["python3", "plugins/wasm-agent/tests/master_frontier_active_space_context.test.py"], "behavioral"),
    ("client-ui-actions", ["python3", "plugins/wasm-agent/tests/master_frontier_client_ui_actions.test.py"], "behavioral"),
    ("controller-router", ["python3", "plugins/wasm-agent/tests/master_frontier_controller_router.test.py"], "static"),
    ("status-panel", ["node", "plugins/wasm-agent/tests/master_frontier_status_panel.test.mjs"], "behavioral"),
    ("token-ledger", ["python3", "plugins/wasm-agent/tests/master_frontier_token_ledger.test.py"], "behavioral"),
    ("v5-context-accounting", ["python3", "plugins/wasm-agent/tests/master_frontier_v5_context_accounting.test.py"], "behavioral"),
    ("v6-contracts", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_contracts.test.py"], "static"),
    ("v6-controller", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_controller.test.py"], "behavioral"),
    ("v6-cross-language", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_cross_language.test.py"], "behavioral"),
    ("v6-host-concurrency", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_host_concurrency.test.py"], "behavioral"),
    ("v6-kernel", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_kernel.test.py"], "behavioral"),
    ("v6-mcp-host", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_mcp_host.test.py"], "behavioral"),
    ("v6-mcp-transport", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_mcp_transport.test.py"], "behavioral"),
    ("v6-owned-controller", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_owned_controller.test.py"], "behavioral"),
    ("v6-performance", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_performance.test.py"], "behavioral"),
    ("v6-persistence", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_persistence.test.py"], "behavioral"),
    ("v6-provider-step", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_provider_step.test.py"], "behavioral"),
    ("v6-stall-diagnostic", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_stall_diagnostic.test.py"], "behavioral"),
    ("v6-trajectory", ["python3", "plugins/wasm-agent/tests/master_frontier_v6_trajectory.test.py"], "behavioral"),
