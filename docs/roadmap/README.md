...
| `asolaria-acceleration` | Descriptor-first evolution, tuple/hash proof receipts, bounded hot-op loops, and capability-kernel reuse inspired by public Asolaria repositories | implemented-unverified | Capability Foundry, ASOLARIA widget/calibration, and event-integrity/anchor contracts have focused local proof; no deployed runtime or ASI claim; track detail: [asolaria-acceleration/README.md](asolaria-acceleration/README.md) |
