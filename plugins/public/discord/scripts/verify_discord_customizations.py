...
WORKSPACE = Path(os.getenv("HERMES_DISCORD_PLUGIN_DIR", "/local/plugins/public/discord")).resolve()
PRIVATE_WORKSPACE = Path(
    os.getenv("HERMES_DISCORD_PRIVATE_DIR", "/local/plugins/private/discord")
).resolve()
...
CHANNEL_ACL_PUBLIC_SRC = WORKSPACE / "hooks" / "channel_acl"
CHANNEL_ACL_PRIVATE_SRC = PRIVATE_WORKSPACE / "hooks" / "channel_acl"
...
SLASH_BRIDGE_PUBLIC_SRC_DIR = WORKSPACE / "hooks" / "discord_slash_bridge"
SLASH_BRIDGE_PRIVATE_SRC_DIR = PRIVATE_WORKSPACE / "hooks" / "discord_slash_bridge"
SLASH_BRIDGE_DST_DIR = HERMES_HOME / "hooks" / "discord_slash_bridge"
SLASH_BRIDGE_CFG_SRC = SLASH_BRIDGE_PRIVATE_SRC_DIR / "config.yaml"
SLASH_BRIDGE_CFG_DST = SLASH_BRIDGE_DST_DIR / "config.yaml"
SLASH_BRIDGE_REGISTRY_SRC = SLASH_BRIDGE_PRIVATE_SRC_DIR / "registry.yaml"
SLASH_BRIDGE_REGISTRY_DST = SLASH_BRIDGE_DST_DIR / "registry.yaml"
SLASH_BRIDGE_HANDLERS_SRC = SLASH_BRIDGE_PUBLIC_SRC_DIR / "handlers.py"
