#!/usr/bin/env python3
"""Bootstrap the wiki-engine project plugin into a node runtime."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Bootstrap the wiki-engine project plugin into Hermes.")
    parser.add_argument("--env-file", required=True)
    parser.add_argument("--config-file", default="")
    parser.add_argument("--plugin-source", default="/local/plugins/public/native/wiki-engine")
    parser.add_argument("--plugin-name", default="wiki-engine")
    ...
    enabled = _is_truthy(env.get("PLUGIN_WIKI_ENGINE", ""))
