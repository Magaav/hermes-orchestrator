#!/usr/bin/env python3
"""Bootstrap the Hermes-native browser-plus plugin into a node runtime."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Bootstrap the browser-plus project plugin into Hermes.")
    parser.add_argument("--env-file", required=True)
    parser.add_argument("--config-file", default="")
    parser.add_argument("--plugin-source", default="/local/plugins/public/native/browser-plus")
    parser.add_argument("--plugin-name", default="browser-plus")
    ...
    enabled = _is_truthy(env.get("PLUGIN_BROWSER_PLUS", ""))
