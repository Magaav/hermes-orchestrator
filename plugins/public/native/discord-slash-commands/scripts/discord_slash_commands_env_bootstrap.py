#!/usr/bin/env python3
"""Bootstrap the discord-slash-commands project plugin into a node runtime."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Bootstrap the discord-slash-commands project plugin into Hermes.")
    parser.add_argument("--env-file", required=True)
    parser.add_argument("--config-file", default="")
    parser.add_argument("--plugin-source", default="/local/plugins/public/native/discord-slash-commands")
    ...
    enabled = _is_truthy(env.get("PLUGIN_DISCORD_SLASH_COMMANDS", ""))
