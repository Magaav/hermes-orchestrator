...
JSON_SCHEMAS: dict[str, dict[str, Any]] = {
    "node_card": {
        ...
        "title": "Hermes Space UI Node Card",
        "type": "object",
    ...
    "logs_panel": {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "title": "Hermes Space UI Logs Panel",
        "type": "object",
    ...
    "action_button": {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "title": "Hermes Space UI Action Button",
        "type": "object",
    ...
    "task_status": {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "title": "Hermes Space UI Task Status",
        "type": "object",
    ...
    "dashboard_layout": {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "title": "Hermes Space UI Dashboard Layout",
        "type": "object",
    ...
    "host_resources": {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "title": "Hermes Space UI Host Resources",
        "type": "object",
    ...
    "node_stats": {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "title": "Hermes Space UI Node Stats",
        "type": "object",
    ...
    "node_create_result": {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "title": "Hermes Space UI Node Create Result",
        "type": "object",
