...
class RoutesTest(unittest.TestCase):
    ...
    def test_exhaust_slash_prompt_accepts_newline_after_command(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            previous_runtime = os.environ.get("HERMES_SPACE_UI_EXHAUST_RUNTIME")
            os.environ["HERMES_SPACE_UI_EXHAUST_RUNTIME"] = str(tmp_path / "missing-runtime.py")
            try:
                ...
                if previous_runtime is None:
                    os.environ.pop("HERMES_SPACE_UI_EXHAUST_RUNTIME", None)
                else:
                    os.environ["HERMES_SPACE_UI_EXHAUST_RUNTIME"] = previous_runtime
