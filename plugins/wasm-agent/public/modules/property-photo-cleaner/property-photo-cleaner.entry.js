...
} from "./modules/local-object-cleaner.js?v=20260727-lama-baseline1";
...
export async function mount(context = {}) {
  ...
  function updateProcessingUi() {
    ...
    const labels = {
      ...
      "loading-model": "Loading the local cleaning AI (29 MB) · verified and cached…",
      "model-ready": "Cleaning AI ready · starting reconstruction…",
      reconstructing: `Preparing object ${currentStep} of ${progress.total}…`,
      "building-mask": `Building the removal mask for object ${currentStep} of ${progress.total}…`,
      "mask-ready": `Removal mask ready for object ${currentStep} of ${progress.total}…`,
      "crop-planned": `Reading nearby room context for object ${currentStep} of ${progress.total}…`,
      "pixels-resized": `Preparing LiteRT input for object ${currentStep} of ${progress.total}…`,
      "arrays-packed": `Packing local image tensors for object ${currentStep} of ${progress.total}…`,
      "tensors-created": `LiteRT tensors ready for object ${currentStep} of ${progress.total}…`,
      "inference-starting": `Reconstructing object ${currentStep} of ${progress.total} locally…`,
      "inference-complete": `Reconstruction generated for object ${currentStep} of ${progress.total}…`,
      "output-ready": `Blending reconstruction ${currentStep} of ${progress.total}…`,
      reconstructed: `Object ${progress.current} of ${progress.total} reconstructed…`
    };
