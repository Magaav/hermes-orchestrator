...
- Shared spaces must have explicit owner/member records and join codes under
  ...
  as peer pointer motion, soft cursor navigation follow, and click/touch pulses,
  but the room poll remains the fallback contract and all events must still be
  member-gated by the server.
