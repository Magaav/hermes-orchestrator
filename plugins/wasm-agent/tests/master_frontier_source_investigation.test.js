...
(async () => {
  ...
  assert.strictEqual(objectiveKind("Change it."), "model_decision");
  ...
  assert.strictEqual(source.masterFrontierProtocolRequest("Hello", "conversation", "v6").protocol, "v6");
  assert.strictEqual(source.masterFrontierProtocolRequest("Criticize this widget implementation", "diagnosis", "").protocol, "v6");
  ...
  assert.strictEqual(source.masterFrontierExplicitProtocol("?frontier=v6", ""), "v6");
  assert.strictEqual(source.masterFrontierExplicitProtocol("", "explicit:v5"), "v5");
  assert.strictEqual(source.masterFrontierExplicitProtocol("", "v5"), "v6", "legacy pre-promotion storage must migrate to V6");
  assert.strictEqual(source.masterFrontierExplicitProtocol("", ""), "v6");
