...
class RuntimeFixture:
    ...
    def __init__(self, route, decisions, clients=None, db_path=None):
        self.route = route
    ...
    def values(self):
        return {
            ...
            "read_json_file": lambda _path, _fallback: {"status": "finished", "result": {"ok": True}},
...
class V6OwnedControllerTests(unittest.TestCase):
    ...
    def test_live_client_widget_operation_is_acknowledged(self) -> None:
        ...
        runtime = RuntimeFixture(route, [
            call("discover", {"query": "open browser widget"}),
            call("execute", {"operations": [{
                "id": "op.open", "cap": "client.widget.open",
                "args": {"client": "electron-renderer", "widget": "browser", "wait_sec": 0},
        ...
        result = controller_v6.execute_owned(
            ...
            context={"receiver": "provider", "envelope": {
                "objective": "Open the Browser widget", "task_contract": {"request_class": "conversation"},
