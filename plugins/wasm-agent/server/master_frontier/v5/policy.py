...
def tool_descriptors() -> list[dict[str, Any]]:
    descriptors = [
        ...
        {"name": "client", "description": "Inspect or control live clients and the current user's Windows desktop through bounded inspect-act-prove UI Automation, companion overlay, CDP realm launch, or unrestricted Windows shell execution. Actions return correlated receipts.", "input_schema": {"type": "object", "required": ["operation"], "properties": {"operation": {"type": "string", "enum": ["inspect", "space_catalog", "open_widget", "space_open", "windows_shell_execute_unrestricted", "show_companion_overlay", "run_notepad_uia_canary", "windows_desktop_describe", "windows_desktop_inspect", "windows_desktop_act", "windows_desktop_prove", "command_status"]}, "client_id": {"type": "string", "maxLength": 120}, "widget_id": {"type": "string", "maxLength": 80}, "space": {"type": "string", "maxLength": 160}, "command": {"type": "string", "maxLength": 1048576}, "shell": {"type": "string", "enum": ["powershell", "cmd"]}, "cwd": {"type": "string", "maxLength": 32768}, "environment": {"type": "object", "additionalProperties": {"type": ["string", "number", "boolean"]}, "maxProperties": 128}, "canary": {"type": "string", "minLength": 1, "maxLength": 240}, "target": {"type": "object", "properties": {"hwnd": {"type": ["string", "integer"]}, "process_id": {"type": "integer", "minimum": 1}, "title_contains": {"type": "string", "maxLength": 240}}, "additionalProperties": False}, "max_elements": {"type": "integer", "minimum": 1, "maximum": 200}, "max_depth": {"type": "integer", "minimum": 1, "maximum": 32}, "include_values": {"type": "boolean"}, "snapshot_id": {"type": "string", "pattern": "^s-[a-f0-9]{16}$"}, "ref": {"type": "string", "pattern": "^e[0-9]{1,3}$"}, "action": {"type": "string", "enum": ["focus", "invoke", "click", "set_value", "toggle", "select", "expand", "collapse"]}, "value": {"type": "string", "maxLength": 4096}, "expect": {"type": "object", "required": ["property", "equals"], "properties": {"property": {"type": "string", "enum": ["name", "value", "toggle_state", "enabled", "offscreen", "selected", "expanded"]}, "equals": {"type": ["string", "number", "boolean"]}}, "additionalProperties": False}, "timeout_ms": {"type": "integer", "minimum": 1000, "maximum": 240000}, "command_id": {"type": "string", "maxLength": 120}, "wait_sec": {"type": "number", "minimum": 0, "maximum": 30}}, "additionalProperties": False}},
    ...
    client = next(item for item in descriptors if item["name"] == "client")
    operations = client["input_schema"]["properties"]["operation"]["enum"]
    operations[2:2] = ["runtime_diagnose", "runtime_refresh"]
    client["input_schema"]["properties"]["lease_ms"] = {"type": "integer", "minimum": 5000, "maximum": 120000}
    return descriptors
