...
def tool_descriptors() -> list[dict[str, Any]]:
    return [
        ...
        {"name": "client", "description": "Inspect or control live Electron clients. Full-power operations execute arbitrary JavaScript in the native Browser main world or arbitrary commands as the installed Windows user; command semantics are not allowlisted. Actions return correlated receipts with bounded transport output.", "input_schema": {"type": "object", "required": ["operation"], "properties": {"operation": {"type": "string", "enum": ["inspect", "browser_inspect", "open_widget", "space_open", "browser_navigate", "browser_input_receipt", "browser_pointer_dispatch", "browser_javascript_execute_unrestricted", "windows_shell_execute_unrestricted", "command_status"]}, "client_id": {"type": "string", "maxLength": 120}, "widget_id": {"type": "string", "maxLength": 80}, "space": {"type": "string", "maxLength": 160}, "url": {"type": "string", "maxLength": 2000}, "enabled": {"type": "boolean"}, "x": {"type": "integer", "minimum": 0, "maximum": 65535}, "y": {"type": "integer", "minimum": 0, "maximum": 65535}, "javascript": {"type": "string", "maxLength": 1048576}, "command": {"type": "string", "maxLength": 1048576}, "shell": {"type": "string", "enum": ["powershell", "cmd"]}, "cwd": {"type": "string", "maxLength": 32768}, "environment": {"type": "object", "additionalProperties": {"type": ["string", "number", "boolean"]}, "maxProperties": 128}, "timeout_ms": {"type": "integer", "minimum": 1000, "maximum": 240000}, "command_id": {"type": "string", "maxLength": 120}, "wait_sec": {"type": "number", "minimum": 0, "maximum": 30}}, "additionalProperties": False}},
