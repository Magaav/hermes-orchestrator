...
if command -v node >/dev/null 2>&1; then
  ...
  node "${PLUGIN_DIR}/tests/shared_pointer_renderer.test.mjs"
...
python3 "${PLUGIN_DIR}/tests/spaces_regression.test.py"
python3 "${PLUGIN_DIR}/tests/shared_pointer_browser_smoke.py"
