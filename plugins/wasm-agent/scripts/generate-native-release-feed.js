...
function hotOperationArtifacts() {
  ...
  const specs = [
    ...
    },
    {
      ...
      operationName: "set_windows_audio_render_default",
      sourceModule: path.join(opsRoot, "audio", "windows-audio-default.js"),
      sourceManifest: path.join(opsRoot, "audio", "windows-audio-render-default.manifest.json"),
      publicDir: path.join(releaseRoot, "audio"),
      publicBase: "/native/releases/hot-ops/audio",
      moduleName: "windows-audio-default.js",
      manifestName: "windows-audio-render-default.manifest.json",
    },
    {
      id: "windows-audio-default",
      platform: "audio",
      name: "windowsAudioDefault",
      operationName: "set_windows_audio_capture_default",
      sourceModule: path.join(opsRoot, "audio", "windows-audio-default.js"),
      sourceManifest: path.join(opsRoot, "audio", "windows-audio-default.manifest.json"),
      publicDir: path.join(releaseRoot, "audio"),
      publicBase: "/native/releases/hot-ops/audio",
      moduleName: "windows-audio-default.js",
      manifestName: "windows-audio-default.manifest.json",
    },
    {
      id: "windows-audio-loopback-probe",
      platform: "audio",
      name: "windowsAudioLoopbackProbe",
      operationName: "inspect_windows_audio_loopback",
      sourceModule: path.join(opsRoot, "audio", "windows-audio-loopback-probe.js"),
      sourceManifest: path.join(opsRoot, "audio", "windows-audio-loopback-probe.manifest.json"),
      publicDir: path.join(releaseRoot, "audio"),
      publicBase: "/native/releases/hot-ops/audio",
      moduleName: "windows-audio-loopback-probe.js",
      manifestName: "windows-audio-loopback-probe.manifest.json",
    },
    {
      id: "windows-audio-signal-probe",
      platform: "audio",
      name: "windowsAudioSignalProbe",
      operationName: "probe_windows_audio_signal",
      sourceModule: path.join(opsRoot, "audio", "windows-audio-signal-probe.js"),
      sourceManifest: path.join(opsRoot, "audio", "windows-audio-signal-probe.manifest.json"),
      publicDir: path.join(releaseRoot, "audio"),
      publicBase: "/native/releases/hot-ops/audio",
      moduleName: "windows-audio-signal-probe.js",
      manifestName: "windows-audio-signal-probe.manifest.json",
    },
    {
